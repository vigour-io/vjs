...
// make folder is require(util/is/stream)
// make folder is require(util/is/number)
// make folder is require(util/is/plainobj)
// make folder is require(util/is/numberlike)
// make folder is require(util/is/empty)
// make folder is require(util/is/removed)
// make folder is require(util/is/arraylike)
// requireing util simply requires all functions
// requing is requires all is functions
// this pattern is pretty nice
...
exports.isArrayLike = function (obj) {
  ...
  if (onlyNumbers && asArray && ordered) {
    obj = asArray
  }
  // if (onlyNumbers) {
