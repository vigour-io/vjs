...
var Emitter = module.exports = new Base({
  ...
  $define: {
    remove: function( instances, event ) {
      console.error('imma gettin emitter removed handle listeners shit')
      ...
      if( 
        ...
        if( !this.__$bind__ ) {
          ...
          if(this._$parent && !this.hasOwnProperty('__$bind__')) {
            console.error('I DONT HAVE MY OWN BOUND', this.$path, 'from', this.__proto__.$path)
          }
        }
