...
function Condition (val, event, parent, key, escape) {
  // Event
  console.log('create a condition!', event)
  // var creator
  // if (!event) {
  //   console.error('ok create this bitch! why????')
  //   creator = true
  //   event = new Event(this, 'new') // this is fucked!
  // }
  if (event) {
    this._ignoreStamp = event.stamp
  }
  // Base.vall(this, val, false,  )
  // if (creator) {
  //   console.error('ok trigger this bitch!')
  //   // this should only fire other things the the condition
  //   // this._parent.
