      ...
      if( instances ) {
        ...
        if(instances){
          for(var i = 0, length = instances.length; i < length; i++) {
            ...
            if(instance){
              instance.$emit.apply( instance, args )
              // console.log('instance! context:',instance._$context)
              // console.log('instance! contextLevel:',instance._$contextLevel)
              // console.log('instance! contextKey:',instance._$contextKey)
              // instance._$context
              // instance._$contextLevel
              // instance._$contextKey
              // instance.$emit.apply( instance, args )
            }
          }
        }
