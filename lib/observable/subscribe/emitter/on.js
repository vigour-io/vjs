...
exports.upward = function (event, meta, emitter, pattern, info, map, mapvalue) {
...
exports.parent = function (event, meta, emitter, pattern, info, map, mapvalue) {
  map[this.key] = mapvalue
  subscribe(emitter, event, {}, this.parent, pattern, 'parent', info, map)
// should I remove the parent listener now? Perhaps keep it for the instances
}

exports.property = function (event, meta, emitter, pattern, info, map, mapvalue) {
...
exports.reference = function (event, meta, emitter, pattern, info, map, mapvalue) {
  ...
  if (referenced) {
    emitter.subscribe(event, meta, referenced, pattern, info, map, mapvalue)
  }
}
