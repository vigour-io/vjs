...
module.exports = function (data, event, obj, pattern, info, mapvalue = true, map = {}) {
  ...
  for (var key in pattern) {
    ...
    if (property && property._input !== null) {
      ...
      console.log(key,obj.key,'subscribe prop',property, property._input)
