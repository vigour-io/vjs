'use strict'
module.exports = function onReference ( event, meta, subsemitter, refLevel, level, val, prevMap ) {
  ...
  if ( referenced ) {
    subsemitter.$loopSubsObject(referenced, val, event, refLevel, level, meta, prevMap)
  }
}
