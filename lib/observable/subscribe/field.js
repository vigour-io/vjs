...
exports.define = {
  ...
  subField (data, event, obs, field, current, mapvalue, map) {
    ...
    if (id) {
      ...
      console.log('endpoint:',this.path, this.uid, id)

      if (data) {
        onData.call(obs, data, event, this, field, current, mapvalue)
      }
  ...
  subFieldRef (data, event, obs, field, current, mapvalue, map, context) {
    ...
    if (id) {
      ...
      field.val = setId(current, id)
      if (data) {
        onDataRef.call(obs, data, event, this, field, current, mapvalue, context)
      }
