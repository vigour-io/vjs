  ...
  observable.define({
    ...
    set: function( val, event, nocontext ) {
      ...
      if( event === void 0 ) {
        ...
        event.$val = val
        // console.log('%ccreate event', 'color:blue;font-weight:bold;', event.$stamp)
      }

      var base = set.call( this, val, event, nocontext )

      // console.log( '\n' )
      // console.log('%cRESULT OF SET','color:red;padding:10px;', '\n', val, base)
      ...
      if( event ) {
        if( !base ) {
          ...
          // console.log('%cemitPostponed from set', 'color:teal;font-weight:bold;', event.$stamp)
          ...
          // if(event.$resolvedContext) {
            // base.$clearContext()
          // }
          // if(!event.$resolvingContext) {


          // console.error('%cemit from set', 'color:teal;font-weight:bold;',
          //   event.$stamp,
    ...
    $addNewProperty: function( key, val, property, event ) {
      ...
      console.log('TERING',fireParentEvent, this[key], key)
