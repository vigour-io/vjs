...
module.exports = function( observable ) {
  ...
  observable.define({
    ...
    set: function( val, event, nocontext ) {
      ...
      console.log('?hexxxre?', event, this._$path)
      ...
      if( event ) {
        if( !base ) {
          ...
          // console.log(this._$path, event.$postponed, this._$context, event)
          this.$emitPostponed( '$change', event )
          // return
        } else {
          console.log('here?', base._$path, event, event.$postponed )
          console.log( event.$origin === base )
