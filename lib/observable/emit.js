  ...
  $emit : function( type, event, meta ) {
    ...
    if( emitter ) {
      ...
      if( meta ) {
        ...
        console.error('!@#!@#!@#--->', this, this._$parent)
    ...
    if( 
      ...
      if( postponed ) {
        ...
        for( var emitter$ ; (emitter$ = postponed[event.i]) ; event.i++ ) {
          if( emitter$ && emitter$._$parent) { // added this check for emitter$._$parent, was wicked when removing reference to origin as part of listener flow
