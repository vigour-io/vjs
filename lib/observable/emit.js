    ...
    if( 
      ...
      if( postponed ) {
        ...
        for( var emitter$ ; (emitter$ = postponed[event.i]) ; event.i++ ) {
          if( emitter$ && emitter$._$parent) { 
            //check for remove -- move to emitter emit
            // added this check for emitter$._$parent, was wicked when removing reference to origin as part of listener flow
            // emitter$._$parent._$parent
