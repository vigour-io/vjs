  ...
  $define: {
    ...
    $generateConstructor: function() {
      return (function On( val, event ) {
        ...
        //hier moet gaurd voor waar je het op hebt geinject...

        // console.log(proto.$path, proto._$parent, this.$path)

        if(proto._$parent) {
          if(!proto._instances) {
            proto._instances = []
          }
          // console.error('ghello!', this._$parent.$path)
    ...
    $newParent: function( parent ) {
      ...
      console.log('new parent bitch', this._$parent.$path, parent.$path)
