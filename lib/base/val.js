...
define( proto, '$origin', {
  get:function() {
    var ref = this
    while( ref._$val instanceof Base ) {
      ref = ref._$val
    }
    return ref
  }
    ...
    if(val) {
      ...
      if(typeof val === 'function') {
        ...
        if(context) {
          ...
          if(this._$bind._$val === '$parent') {
            context = this.$parent
          } else if(typeof this._$bind._$val=== 'function' ) {
            context = this._$bind._$val.call(this)
          } else {
            context = this
          }
        }
        ...
        //dit is goed want zo neemt ie ook operators mee etc voor tussen tijdse standen
        return val.$val
      } else {
        return this._$val
      }
