 ...
 * @param  {*} value - overide selector this["key"]
 */
exports.createContextGetter = function (key, value) {
  if (value) {
    console.error('has value -- if this is never true remove', value)
  }
  if ((value = this.contextCandidate(key, value))) {
...
exports.resolveContext = function (val, event, context, alwaysreturn) {
  ...
  if (context._context) {
    context = context.resolveContextSet({}, event, context._context, true)
  }
