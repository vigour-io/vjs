...
exports.setKey = function (key, val, event, nocontext, escape) {
  return this.properties[key] && !escape ? this.properties[key].call(this, val, event, nocontext, key, escape) : this.setKeyInternal(key, val, this[key], event, nocontext, escape)
}
