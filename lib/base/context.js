...
exports.$resolveContextSet = function( val, event, context ) {
  ...
  // if(i) {
    ...
    console.log(iterator, path, iterator.$key)
    ...
    //     this,
    //     false, //  event,
    //     // i === pathLengthCompare ? event : false, //this will break cases like bla.b.c set ( 2 levels in setobj )
    //     true);
    //
    //     // context = context[]
    //
    // } else {
      ...
      // if(context) context.$resetContextsUp()
