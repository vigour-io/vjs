...
var On = module.exports = new Base({
  ...
  $define: {
    ...
    on: function( type, val, id ) {
      //type
      //maybe later add a thing called bubble or something
      //this way of doing things will create a new id automaticly if no if is provided
      //id === '$val' means on the _$val
