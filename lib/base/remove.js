...
exports.removeProperty = function (property, key, event, nocontext) {
  // && key !== '__on'
  if (key !== 'key' && key !== '_uid' && key !== '_markDirty') { // this is it how to solve????
    if (this.hasOwnProperty(key)) {
      ...
      if (this._context) {
        // problem is event gets triggered when listeners are removed make it defered or something attch it to the current event?
