...
exports.$removeUpdateParent = function( parent, removeInstances, event ) {
...
exports.$removeInternal = function( removeInstances, event ) {

  var parent = this._$parent
  var contextParent

  if( !removeInstances && parent !== ( contextParent = this.$parent ) ) {
    console.warn(
      'context removal' ,
    ...
    if( parent ) {
      this.$removeUpdateParent( parent, removeInstances, event )
    }
    for( var key$ in this ) {
...
exports.remove = function( removeInstances, event ) {
  if( this._$val === null ) {
    console.warn( 'allready removed' )
    return true
  }
  return this.$removeInternal( removeInstances, event )
}
